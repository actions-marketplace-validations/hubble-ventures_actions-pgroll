...
- pgroll binary is downloaded from official GitHub releases with caching

## Testing

Integration tests run against PostgreSQL 16 service container in GitHub Actions.
Tests cover setup (Linux, macOS, Windows), validation, and full migration workflows.

## Release Process

1. Semantic versioning (v1.0.0, v1.1.0, etc.)
2. Major version tags (v1, v2) for stability
3. Automated release workflow (to be added)
